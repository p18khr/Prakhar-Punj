...
<%@page import="com.training.nagarro.advancedJava3.model.User"%>
<%@page import="com.training.nagarro.advancedJava3.dao.GetImageData"%>
<%@page import="com.training.nagarro.advancedJava3.model.Product"%>
